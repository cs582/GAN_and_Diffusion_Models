...
if __name__ == "__main__":
    ...
    if args.model == "GAN":
        if args.dataset == "MNIST":
            GAN_MNIST.run(epochs=args.epochs, batch_size=args.bach_size, latent_vector_size=args.vector_size, lr=args.lr)

    if args.model == "DIFF":
        if args.dataset == "MNIST":
            DIFF_MNIST.run(batch_size=args.bach_size, timesteps=args.timesteps, latent_vector_size=args.vector_size, lr=args.lr)
